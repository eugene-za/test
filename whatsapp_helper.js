            ...
            return new Promise(function (resolve, reject) {
                var observer = new MutationObserver(function (mutations) {
                    mutations.forEach(function (mutation) {
                        ...
                        // Селектор для Текстовой области - '._1UWac._1LbR4'
                        if (mutation.target.matches('._1UWac._1LbR4') && mutation.target.textContent.includes(phoneNumber)/*&& mutation.target.textContent*/) {
                            observer.disconnect();
